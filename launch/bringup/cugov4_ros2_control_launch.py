...
def generate_launch_description():
    ...
    tread                          = LaunchConfiguration('tread'                         ,default=0.376)  # default: CuGO V4
    reduction_ratio                = LaunchConfiguration('reduction_ratio'               ,default=20.0)
    encoder_max                    = LaunchConfiguration('encoder_max'                   ,default=2147483647) # -2147483648 ~ 2147483647(Arduinoのlong intは32bit)
    encoder_resolution             = LaunchConfiguration("encoder_resolution"            ,default=30)
