...
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, EmitEvent, TimerAction
    ...
    return LaunchDescription([
        TimerAction(period=1.0,actions=[
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(launch_dir, 'sensors/RT_imu_bringup_launch.py')),
                launch_arguments={
                    'imu_topic'       : imu_topic,
